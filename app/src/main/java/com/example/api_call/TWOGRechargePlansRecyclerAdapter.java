...
public class TWOGRechargePlansRecyclerAdapter extends RecyclerView.Adapter<TWOGRechargePlansRecyclerAdapter.ViewHolder>{

    private static Context mContext;
    private int PLANREQUESTCODE = 200;
    List<G> data;
    OnClickDataa onClickDataa;
    String searchType;

    public interface OnClickDataa {
        void getdata(G g);
    }

    public TWOGRechargePlansRecyclerAdapter(Context aContext, List<G> data, OnClickDataa onClickDataa) {
        mContext = aContext;
        this.onClickDataa = onClickDataa;
        this.data = data;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
//            TWOGRechargePlansRecyclerAdapter.this = this$0;
            ...
            itemView.setOnClickListener(new View.OnClickListener() { // from class: com.uvapay.adapters.rechargeplan.TWOGRechargePlansRecyclerAdapter.ViewHolder.1
                @Override // android.view.View.OnClickListener
                public void onClick(View v) {
                    TWOGRechargePlansRecyclerAdapter.this.onClickDataa.getdata(TWOGRechargePlansRecyclerAdapter.this.data.get(ViewHolder.this.getAdapterPosition()));
                }
            });
        }
    }
