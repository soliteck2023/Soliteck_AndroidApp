...
public class ROfferAdapter extends RecyclerView.Adapter<ROfferAdapter.ViewHolder>{
    ...
    public ROfferAdapter(Context aContext, List<MobilePlanRecord> data, OnclickData onclickData) {
...
//            ROfferAdapter.this = this$0;
            ...
            itemView.setOnClickListener(new View.OnClickListener() { // from class: com.uvapay.adapters.ROfferAdapter.ViewHolder.1
