...
public class TopUpRechargePlansRecyclerAdapter extends RecyclerView.Adapter<TopUpRechargePlansRecyclerAdapter.ViewHolder> {
    ...
    public TopUpRechargePlansRecyclerAdapter(Context aContext, List<TOPUP> data, OnCl onCl) {
        mContext = aContext;
        this.onCl = onCl;
        this.data = data;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
//            TopUpRechargePlansRecyclerAdapter.this = this$0;
            ...
            itemView.setOnClickListener(new View.OnClickListener() { // from class: com.uvapay.adapters.rechargeplan.TopUpRechargePlansRecyclerAdapter.ViewHolder.1
