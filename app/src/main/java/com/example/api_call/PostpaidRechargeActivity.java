...
public class PostpaidRechargeActivity extends AppCompatActivity {
    ...
    private Spinner edit_postpaid_operator;
        ...
        this.btn_postpaid_Recharge.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               if ( PostpaidRechargeActivity.this.edit_postpaid_amt.getText().toString().trim().isEmpty()){
                ...
                postpaidRechargeActivity.getMobileConformation(postpaidRechargeActivity.edit_postpaid_amt.getText().toString(), PostpaidRechargeActivity.this.edit_mobile_number.getText().toString(), PostpaidRechargeActivity.this.edit_postpaid_operator.getSelectedItem().toString());
    ...
    private void initComponents() {
        ...
        this.edit_postpaid_operator = (Spinner) findViewById(R.id.edit_postpaid_operator);
